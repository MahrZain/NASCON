"""
Django settings for mynascon project.
...
SECRET_KEY = 'django-insecure-y1kjgfo1+$4v1^^5@#!9^$n%5buqghwfyftrgnbq=qn&1w8elc'
...
WSGI_APPLICATION = 'mynascon.wsgi.application'
